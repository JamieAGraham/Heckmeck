...
# Create players
players = [
    Player("Player 23", target_score=23),
    Player("Player 24", target_score=24),
    Player("Player 25", target_score=25),
    Player_Sigmoid("Player 26", target_score=26),
    Player_Sigmoid("Player 27", target_score=27),
    Player_Sigmoid("Player 28", target_score=28)
]
